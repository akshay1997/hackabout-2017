...
model.load_weights("model_files/this.best.hdf5",by_name=True)
res = model.predict_classes([sentenceTest, positionTest1, positionTest2],batch_size = 64, verbose=0)
print res
opfile(res)
get_accuracy('output.txt','SemEval2010_task8_all_data/SemEval2010_task8_testing_keys/TEST_FILE_KEY.TXT')
print "Testing done"